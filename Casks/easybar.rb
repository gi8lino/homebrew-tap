cask "easybar" do
  version "0.18.0"
  sha256 "1746df7b02018a9d58c1bde372d8bad4a9d4d2f319bd4e8192962b1f625bd24f"

  url "https://github.com/gi8lino/easybar/releases/download/v0.18.0/EasyBar-0.18.0.zip"
  name "EasyBar"
