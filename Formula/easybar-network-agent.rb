class EasybarNetworkAgent < Formula
  ...
  url "https://github.com/gi8lino/easybar/releases/download/v0.27.1/EasyBarNetworkAgent-0.27.1.zip"
  sha256 "4a822252d6b10dd0292f10907a16b0cc9b734ff1a976dddff47c6a6ea7cd9e3c"
  license "Apache-2.0"
  version "0.27.1"
