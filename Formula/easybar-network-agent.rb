class EasybarNetworkAgent < Formula
  ...
  url "https://github.com/gi8lino/easybar/releases/download/v0.5.0/EasyBar-0.5.0.zip"
  sha256 "3462ba3392af646703bf6a3ed6903b69ee759db8e11949ea272cf9beda5767da"
  license "Apache-2.0"
  version "0.5.0"
